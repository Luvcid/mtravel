               ...
               <!-- Main Menu -->
                ...
                <div id="content" class="reservation">
                    <div class="container section">
                        ...
                        M-Travel Adalah Tugas Projek Tujuan
                          Merancang dan membangun Sistem Pemesanan dan Informasi Traveling untuk kalangan masyarakkat.
                        </div>
                    </div>
                </div>
                ...
                <div id="copyright">
                    <div class="container section end">
                        ...
                        <span id="text">Copyright &copy; <?php date_default_timezone_set('Asia/Jakarta'); echo date('Y');?> | <a href="http://mfikri.com">luaylabib</a>.</span>
