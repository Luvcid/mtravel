...
<!-- Meta tags -->
        ...
        <meta name="author" content="safiijiva" />
               ...
               <!-- Main Menu -->
                ...
                <div id="content" class="reservation">
                    <div class="container section">
                        <div class="one-third column">
                            <h3 class="nobg"><h1>Ketentuan dan Kebijakan</h1>
                            <p><h3>1. Setalah melakukan pembayaran anda wajib mengkofirmasi kami melalui from ini.</p>
                    ...
                    <div class="container section end">
                        <div id="footer-about" class="one-fourth column">
                            ...
                            <p>
                                ...
                                <span>Email: luaylabib@gmail.com</span>
                            </p>
                        </div>
                ...
                <div id="copyright">
                    <div class="container section end">
                        ...
                        <span id="text">Copyright &copy; <?php date_default_timezone_set('Asia/Jakarta'); echo date('Y');?> | <a href="http://mfikri.com">safiijiva</a>.</span>
